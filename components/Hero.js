...
export default function Hero() {
  return (
    <div className='py-4 flex flex-col gap-8 sm:gap-10'>
      <h1 className={ 'text-5xl sm:text-text-6xl md:text-7xl text-center  ' + fugaz.className}><span className='textGradient'>Mooodify</span> helps you track <span className='textGradient'>daily</span> Mood!</h1>
