...
export default function Hero() {
  return (
    <div className='py-4 md:py-10 flex flex-col gap-4 sm:gap-8'>
      <h1 className={ 'text-5xl sm:text-text-6xl md:text-7xl text-center  ' + fugaz.className}><span className='textGtadient'>Mooodify</span> helps you track <span className='textGtadient'>daily</span> Mood!</h1>
