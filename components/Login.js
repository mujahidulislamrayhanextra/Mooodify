...
export default function Login() {
    ...
    return (
        <div className='flex flex-col flex-1 justify-center items-center gap-4'>
            ...
            <input value={email} onChange={(e) => {setEmail(e.target.value)} }  className='w-full max-w-[400px] mx-auto px-3 duration-200 hover:border-indigo-600 focus:border-indigo-600 py-2 sm:py-3 border border-solid border-indigo-400 rounded-full outline-none' placeholder='Email' />
            ...
            <div className='max-w-[400px] w-full mx-auto'>
                ...
                <Button clickHandeler={handleSubmit} text={ authenticating ? "Submitting" : "Submit"} full/>
            </div>
            <p className='text-center'>
                {isRegister ? "Alreadu have an account? " : "Don't have an account? "}
